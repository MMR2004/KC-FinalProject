...
import com.example.final_project.adapters.AddressAdapter;
import com.example.final_project.models.AddressModel;
...
//        });
        ...
        addAddress.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AdressActivity.this, AddAddressActivity.class));
            }
        });
